...
\begin{frame}{Pipeline Overview: End-to-End Flow}
  ...
  \begin{tikzpicture}[
    ...
    \node[stg] (spl) at (12.75,0)  {\textbf{6.} Split\\[-0.3mm]{\scriptsize 6{,}538 / 1{,}635}};
  ...
  \vspace{1mm}
  {\scriptsize Split is \textbf{stratified}, preserving class proportions. Steps 1--9 are
   learned; the rule engine is deterministic.}
