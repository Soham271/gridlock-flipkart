...
const Loader = () => {
  return (
    <div className="sand-loader-wrapper w-14 h-14 mx-auto">
      <svg aria-label="loader being flipped clockwise and circled by three white curves fading in and out" role="img" height="56px" width="56px" viewBox="0 0 56 56" className="loader">
        ...
        <g transform="translate(2,2)">
          ...
          <g transform="translate(13.75,9.25)" className="loader__model">
            <path d="M 1.5 2 L 23 2 C 23 2 22.5 8.5 19 12 C 16 15.5 13.5 13.5 13.5 16.75 C 13.5 20 16 18 19 21.5 C 22.5 25 23 31.5 23 31.5 L 1.5 31.5 C 1.5 31.5 2 25 5.5 21.5 C 8.5 18 11 20 11 16.75 C 11 13.5 8.5 15.5 5.5 12 C 2 8.5 1.5 2 1.5 2 Z" fill="hsl(var(--hue, 0),90%,85%)" />
            ...
            <rect height={2} width="24.5" fill="hsl(var(--hue, 0),90%,50%)" />
            <rect height={1} width="19.5" y="0.5" x="2.5" ry="0.5" rx="0.5" fill="hsl(var(--hue, 0),90%,57.5%)" />
            <rect height={2} width="24.5" y="31.5" fill="hsl(var(--hue, 0),90%,50%)" />
            <rect height={1} width="19.5" y={32} x="2.5" ry="0.5" rx="0.5" fill="hsl(var(--hue, 0),90%,57.5%)" />
          </g>
        </g>
      </svg>
    </div>
